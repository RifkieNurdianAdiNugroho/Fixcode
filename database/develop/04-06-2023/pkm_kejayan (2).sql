...
INSERT INTO `posyandu_hasil` (`id`, `jadwal_id`, `balita_id`, `bidan_id`, `umur`, `tb`, `bb`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 1, 1, 11, 15, '2023-06-04 16:17:32', '2023-06-05 13:09:09'),
(2, 1, 3, 1, 2, 10, 9, '2023-06-04 16:17:32', '2023-06-05 13:09:09'),
(3, 1, 4, 1, 3, 7, 6, '2023-06-04 16:17:32', '2023-06-05 13:09:09'),
(4, 1, 5, 1, 1, 8, 9, '2023-06-04 16:17:32', '2023-06-05 13:09:09'),
(9, 3, 2, 1, 3, NULL, NULL, '2023-06-04 17:46:48', '2023-06-05 12:04:34'),
(10, 3, 3, 1, 4, NULL, NULL, '2023-06-04 17:46:48', '2023-06-05 12:04:34'),
(11, 3, 4, 1, 5, NULL, NULL, '2023-06-04 17:46:48', '2023-06-05 12:04:34'),
(12, 3, 5, 1, 3, NULL, NULL, '2023-06-04 17:46:48', '2023-06-05 12:04:34'),
(13, 2, 2, 1, 2, 9, NULL, '2023-06-04 17:52:28', '2023-06-05 12:04:34'),
(14, 2, 3, 1, 3, 10, NULL, '2023-06-04 17:52:28', '2023-06-05 12:04:34'),
(15, 2, 4, 1, 4, NULL, NULL, '2023-06-04 17:52:28', '2023-06-05 12:04:34'),
(16, 2, 5, 1, 2, NULL, NULL, '2023-06-04 17:52:28', '2023-06-05 12:04:34');
...
--
-- Table structure for table `posyandu_status_gizi`
--

CREATE TABLE `posyandu_status_gizi` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status_gizi` enum('gizi_lebih','gizi_baik','gizi_sedang','gizi_kurang','gizi_buruk') NOT NULL,
...
--
-- Table structure for table `posyandu_status_gizi_item`
--

CREATE TABLE `posyandu_status_gizi_item` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `posyandu_status_gizi_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Indexes for table `posyandu_status_gizi`
--
ALTER TABLE `posyandu_status_gizi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `posyandu_status_gizi_item`
--
ALTER TABLE `posyandu_status_gizi_item`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `posyandu_status_gizi`
--
ALTER TABLE `posyandu_status_gizi`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `posyandu_status_gizi_item`
--
ALTER TABLE `posyandu_status_gizi_item`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
